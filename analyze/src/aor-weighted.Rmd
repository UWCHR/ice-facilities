...
aor_enforce_adp <- merge(aor_arrests_adp, aor_encounters, by=c('aor', 'fy'))
...
```{r plot_encounters_adp_per_capita}
...
```{r plot_encounters_arrests_per_capita}
