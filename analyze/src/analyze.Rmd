...
# To do: double check this process, filter charts for missing years
...
ggplot(data = df_aor_adp_enforcement_long,
       aes(x = fy, y = pct_diff_adp, group = aor, color = aor)) + 
  geom_line() +
  xlab("Fiscal Year") +
...
ggplot(data = df_aor_adp_enforcement_long,
       aes(x = fy, y = pct_diff_encounters, group = aor, color = aor)) + 
  geom_line() +
  xlab("FY") +
...
ggplot(data = df_aor_adp_enforcement_long,
       aes(x = fy, y = pct_diff_arrests, group = aor, color = aor)) + 
  geom_line() +
  xlab("FY") +
...
ggplot(data = df_aor_adp_enforcement_long,
       aes(x = fy, y = pct_diff_removals, group = aor, color = aor)) + 
  geom_line() +
  xlab("FY") +
